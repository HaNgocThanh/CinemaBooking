...
export default function HeroSection({ featuredMovie }) {
  return (
    <section className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] min-h-screen flex items-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 w-full px-6 sm:px-12 lg:px-[150px] py-20">
        <div className="max-w-3xl">
          ...
          <motion.p
            ...
            className="text-lg text-slate-300 mb-10 max-w-2xl leading-relaxed font-light"
          >
